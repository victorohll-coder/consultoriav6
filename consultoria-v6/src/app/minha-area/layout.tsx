...
export default async function MinhaAreaLayout({
  ...
  // Check if paciente record exists for this email
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <PatientHeader nome={profile.nome || ""} email={profile.email} />
        ...
        {!paciente ? (
          <div className="bg-surface border border-border rounded-xl p-8 text-center">
            ...
            <p className="text-text2 text-sm">
              Seu e-mail ({profile.email}) ainda nao foi cadastrado pelo profissional.
            </p>
